...
Para la orquestación de los flujos y tareas del proceso ETL, se utilizó Prefect, lo que permitió una gestión eficiente del proceso. Finalmente, los datos consolidados fueron almacenados en una base de datos para ser visualizados tanto en la terminal, junto con los logs, como a través de MySQL Workbench.
